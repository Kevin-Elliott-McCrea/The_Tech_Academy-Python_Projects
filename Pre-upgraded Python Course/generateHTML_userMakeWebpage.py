...
import generateHTML_step227.py as functionDoc
...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.btn_browse1 = tk.Button(self.master,width=17,height=2,text='Start writing >>>',command=lambda: functionDoc.userInput())
